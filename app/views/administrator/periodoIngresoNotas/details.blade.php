...
@section('main')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">{{ $profesorId or 'Periodo de Ingreso de Notas' }}</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                                ...
                                <form role="form">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-xs-4">
                                                <label>Año</label>
                                                <input type="number" class="form-control" data-bind="value: password" placeholder="Ingrese el año" value="2015">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
